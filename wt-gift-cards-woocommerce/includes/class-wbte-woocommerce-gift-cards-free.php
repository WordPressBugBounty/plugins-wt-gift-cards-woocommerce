...
class Wbte_Woocommerce_Gift_Cards_Free {
	...
	private function define_public_hooks() {
		...
		*/
		...
		$this->loader->add_action( 'wp_footer', $this->plugin_public, 'change_text_couponcode_to_giftcard' );
		$this->loader->add_filter( 'woocommerce_checkout_coupon_message', $this->plugin_public, 'alter_have_a_coupon_text' );
	}
