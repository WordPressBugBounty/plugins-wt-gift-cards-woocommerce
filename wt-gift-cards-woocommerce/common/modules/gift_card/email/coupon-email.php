	...
	<div class="wt_gc_email_top">
		...
		<div class="wt_gc_from_name_block">
			...
			if ( '' !== $wbte_from ) {
				...
				echo wp_kses_post( sprintf( __( 'Congratulations! You have received a store credit %1$sfrom %2$s.', 'wt-gift-cards-woocommerce' ), '<span class="wt_gc_from_name_box"><span class="wt_gc_from_name_prefix">', '</span><span class="wt_gc_from_name">' . $wbte_from . '</span></span>' ) );
			} else {
		...
		<table style="width:100%; border-spacing:0px; border-collapse:collapse;" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left" valign="bottom" class="wt_gc_email_coupon_code_block">
					<b><?php esc_html_e( 'Coupon code:', 'wt-gift-cards-woocommerce' ); ?></b>
				...
				<td align="right" valign="bottom">
					<b><?php esc_html_e( 'Amount is here!:', 'wt-gift-cards-woocommerce' ); ?></b>
	...
	<div class="wt_gift_coupon_additional_content">       
		...
		<div class="wt_gift_coupon_custom_additional_content">
			<?php
				...
				echo wp_kses_post( apply_filters( 'wt_gc_alter_gift_card_email_custom_addition_content', $wbte_custom_addition_content, $wbte_coupon_obj ) ); // phpcs:ignore
			?>
