	...
	<div class="wt_gc_email_top">
		...
		<div class="wt_gc_from_name_block">
			...
			if ( '' !== $from ) {
				...
				echo wp_kses_post( sprintf( __( 'Congratulations! You have received a store credit %1$sfrom %2$s.', 'wt-gift-cards-woocommerce' ), '<span class="wt_gc_from_name_box"><span class="wt_gc_from_name_prefix">', '</span><span class="wt_gc_from_name">' . $from . '</span></span>' ) );
			} else {
