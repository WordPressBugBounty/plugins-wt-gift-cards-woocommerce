...
if ( version_compare( WBTE_GC_FREE_CROSS_PROMO_BANNER_VERSION, get_option( 'wbfte_promotion_banner_version', WBTE_GC_FREE_CROSS_PROMO_BANNER_VERSION ), '==' ) && ! class_exists( 'Wbte_Cross_Promotion_Banners' ) ) {
	...
	class Wbte_Cross_Promotion_Banners {
		...
		public static function get_banner_version() {
			return WBTE_GC_FREE_CROSS_PROMO_BANNER_VERSION;
		}
	}
