...
$arr = array(
	...
	'remove_email_restriction_for_gift_card'          => __( 'Enable this option to sell gift cards without email restrictions. Gift cards can be redeemed by anyone who enters the correct code during checkout.', 'wt-gift-cards-woocommerce' ),
	...
	'product_page_title_text'	=> __( 'The text will serve as the title of the gift card product page', 'wt-gift-cards-woocommerce' ),
	'product_page_templates_title_text'	=> __( 'The text will serve as the title for the template selection section on the gift card product page', 'wt-gift-cards-woocommerce' ),
