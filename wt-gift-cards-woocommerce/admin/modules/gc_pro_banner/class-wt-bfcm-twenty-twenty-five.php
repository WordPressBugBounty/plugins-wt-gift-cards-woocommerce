...
if ( ! class_exists( 'Wt_Bfcm_Twenty_Twenty_Five' ) ) {
	...
	class Wt_Bfcm_Twenty_Twenty_Five {
		...
		public function __construct() {
			self::$banner_version = WBTE_GC_FREE_VERSION; // Plugin version.
					...
					<div class="wt-bfcm-banner-2025 notice is-dismissible">
						<div class="wt-bfcm-banner-body">
							<div class="wt-bfcm-banner-body-img-section">
								<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . 'assets/images/black-friday-2025.svg' ); ?>" alt="<?php esc_attr_e( 'Black Friday Cyber Monday 2025', 'wt-gift-cards-woocommerce' ); ?>">
							</div>
								...
								<div class="info">
									...
									<?php
										printf(
											...
											'<span>30% ' . esc_html__( 'OFF', 'wt-gift-cards-woocommerce' ) . '</span>'
										);
									?>
									</p>
								</div>
